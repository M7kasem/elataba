        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingRates_Governorates_GovernorateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PricingTiers", x => x.TierId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Carriers",
                columns: new[] { "CarrierId", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, true, "Bosta" },
                    { 2, true, "Aramex" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingRates_CarrierId_GovernorateId",
                table: "ShippingRates",
                columns: new[] { "CarrierId", "GovernorateId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShippingRates_GovernorateId",
                table: "ShippingRates",
